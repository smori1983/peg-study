...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(command) {
          return command;
        },
      peg$c1 = "line from ",
      peg$c2 = peg$literalExpectation("line from ", false),
      peg$c3 = " to ",
      peg$c4 = peg$literalExpectation(" to ", false),
      peg$c5 = function(begin, end) {
          return {
            begin: begin,
            end: end,
          };
